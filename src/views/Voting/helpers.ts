...
import { ADMIN_ADDRESS, PANLUCKY_SPACE, SNAPSHOT_VERSION } from './config'
...
export const generateMetaData = () => {
  return {
    plugins: {},
    network: 56,
    strategies: [{ name: 'Abyss3033', params: { symbol: 'LUCKY', address: getCakeAddress(), decimals: 18 } }],
  }
}
