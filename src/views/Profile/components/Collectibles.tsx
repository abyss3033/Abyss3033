  ...
  return (
    <>
      <Heading as="h4" scale="md" mb="8px">
        {t('Abyss3033 Collectibles')}
      </Heading>
      <Text as="p">
        {t('Abyss3033 Collectibles are special ERC-721 NFTs that can be used on the Abyss3033 platform.')}
      </Text>
      <Text as="p">
        {t('NFTs in this user’s wallet that aren’t approved Abyss3033 Collectibles won’t be shown here.')}
      </Text>
      ...
      <Flex alignItems="center" justifyContent="flex-end">
        <Link to="/collectibles">{t('See all approved Abyss3033 Collectibles')}</Link>
        <ChevronRightIcon />
      </Flex>
    </>
  )
