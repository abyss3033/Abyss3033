...
const EarningsCell: React.FC<EarningsCellProps> = ({ pool, account, userDataLoaded }) => {
  ...
  // These will be reassigned later if its Auto LUCKY vault
  ...
  const labelText = isAutoVault ? t('Recent LUCKY profit') : t('%asset% Earned', { asset: earningToken.symbol })
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    <>
      <Balance fontSize="16px" value={autoCakeToDisplay} decimals={3} bold unit=" LUCKY" />
